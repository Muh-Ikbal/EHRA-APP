...
export default function Conduct({ version, auth }: any) {
    ...
    const handleSubmit = () => {
        ...
        router.post(route('survey.store', version.id), { answers: filteredAnswers }, {
                                            ...
                                            <div className="mt-4">
                                                ...
                                                {q.question_type === 'number' && (
                                                    <input 
                                                        ...
                                                        value={answers[q.id] || ''}
                                                        onChange={(e) => handleChange(q.id, e.target.value)}
                                                        className="w-full rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500 p-4 shadow-sm text-lg"
                                                        placeholder="0"
                                                    />
                                                )}
